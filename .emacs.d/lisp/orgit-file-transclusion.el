...
;; Provenance: the expected repository (docs/epistolary-pinning-plan.md,
;; section 3), shared across sibling repositories by copy, not by load-path coupling.
;;
...
;; REV is normally an annotated tag.
;;
...
(defcustom orgit-file-transclusion-base-url
  "https://github.com/steve-downey/backtick/blob/"
