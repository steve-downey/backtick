...
**Closes:** whichever of [`prefix-arity-selection`](../../unicode-operators/clang/DEVIATIONS.md#prefix-arity-selection), [`over-oper-restrictions`](../../unicode-operators/clang/DEVIATIONS.md#over-oper-restrictions), U§13-folds and [`postfix-operators`](../../unicode-operators/clang/DEVIATIONS.md#postfix-operators) were
...
- **[`prefix-arity-selection`](../../unicode-operators/clang/DEVIATIONS.md#prefix-arity-selection) (prefix use finds a two-parameter operator through its default
  ...
  `CheckOverloadedOperatorDeclaration`. **Interacts with [`over-oper-restrictions`](../../unicode-operators/clang/DEVIATIONS.md#over-oper-restrictions)(b)**; if
  both were decided, implement them together or the second will undo the
  first's tests.
- **[`over-oper-restrictions`](../../unicode-operators/clang/DEVIATIONS.md#over-oper-restrictions) (static member user operators).** Currently rejected. Accepting
  them touches declaration checking and candidate assembly, and — from
  [`expression-node-cost`](../../unicode-operators/clang/DEVIATIONS.md#expression-node-cost)'s three-for-three pattern — expect a *sibling* of the existing
...
- **[`postfix-operators`](../../unicode-operators/clang/DEVIATIONS.md#postfix-operators) postfix.** `U21` priced this as a feasibility probe and the
